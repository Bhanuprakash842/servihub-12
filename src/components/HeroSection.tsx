      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-foreground/10 backdrop-blur-sm border border-primary-foreground/20 mb-8 animate-fade-in">
            ...
            <span className="text-sm text-primary-foreground">Trusted by 1M+ customers across India</span>
          </div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground mb-6 animate-slide-up leading-tight">
            ...
            <span className="relative">
              ...
              <svg className="absolute -bottom-2 left-0 w-full h-3 text-accent" viewBox="0 0 200 12" fill="none">
          ...
          {/* Search Box */}
          <div className="bg-card rounded-2xl p-2 shadow-xl max-w-2xl mx-auto animate-scale-in" style={{ animationDelay: "0.2s" }}>
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <div className="flex gap-2">
                ...
                <Link to={`/services${searchQuery ? `?search=${searchQuery}` : ""}`}>
