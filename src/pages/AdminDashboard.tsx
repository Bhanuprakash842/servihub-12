...
const AdminDashboard = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Admin Dashboard - ServiHub</title>
        <meta name="description" content="ServiHub admin dashboard for managing users, bookings, providers, and platform analytics." />
      </Helmet>
            ...
            <div className="container">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-primary-foreground/80">Manage your platform and monitor performance</p>
                </div>
          ...
          <div className="container py-8">
            <div className="grid lg:grid-cols-5 gap-6">
                  ...
                  <CardContent className="p-4">
                    <nav className="space-y-1">
                      {[
                        ...
                        { icon: Briefcase, label: "Providers", value: "providers", badge: pendingApprovals || undefined },
              ...
              <div className="lg:col-span-4">
                              ...
                              <div key={booking.id} className="flex items-center justify-between py-2 border-b last:border-0">
                                ...
                                <div className="text-right">
                                  ...
                                  <Badge variant={
                                    ...
                                    booking.status === "pending" ? "accent" : "default"
                                  } className="text-xs">
                                    {booking.status}
                                  </Badge>
                                </div>
                        ...
                        <CardContent>
                          <div className="space-y-4">
                            {providers.slice(0, 5).map((provider, index) => (
                              <div key={provider.id} className="flex items-center gap-3 py-2 border-b last:border-0">
                                ...
                                <div className="flex-1">
                                  ...
                                  <p className="text-sm text-muted-foreground">{provider.completedJobs} jobs</p>
                                </div>
                          ...
                          {serviceCategories.slice(0, 8).map((category) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <p className="text-sm text-muted-foreground">{bookings} bookings</p>
                              </div>
                            );
                          })}
                        </div>
                        ...
                        <div className="divide-y">
                          {providers.map((provider) => (
                            <div key={provider.id} className="p-4 flex items-center gap-4">
                              <div className="w-12 h-12 rounded-full gradient-primary flex items-center justify-center text-primary-foreground font-medium">
                                {provider.name.split(" ").map(n => n[0]).join("")}
                              </div>
                              <div className="flex-1">
                                <div className="flex items-center gap-2">
                                  ...
                                  {provider.verified ? (
                                    ...
                                    <Badge variant="accent-light">Pending</Badge>
                                  )}
                                </div>
                                <p className="text-sm text-muted-foreground">
                                  {provider.services.map(s => 
                                    serviceCategories.find(c => c.id === s)?.name
                                  ).join(", ")}
                                </p>
                              </div>
                              <div className="text-center">
                                <p className="font-medium">{provider.completedJobs}</p>
                ...
                {!["overview", "providers", "bookings"].includes(activeTab) && (
                  <Card>
                    <CardHeader>
