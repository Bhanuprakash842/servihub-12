...
const ServicesPage = () => {
  ...
  const filteredServices = useMemo(() => {
    return allServices.filter(service => {
      ...
      const matchesSearch = !localSearch || 
        service.name.toLowerCase().includes(localSearch.toLowerCase()) ||
  ...
  return (
    <>
      <Helmet>
        <title>Browse Services - ServiHub</title>
        <meta name="description" content="Browse and book professional home services. Find carpenters, plumbers, electricians, beauticians, housekeepers and more." />
      </Helmet>
